		...
		<div id="destaque-produtos">
			...
			<div class="item">
				...
				<div class="col-sm-6 col-imagem">
					<img src="resources/core/img/produtos/moto-x.png" alt="Nome do Produto">
				</div>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="box-produto-info">
					<a href="#">
						<img src="resources/core/img/produtos/panelas.png" alt="Panelas" class="produto-img">
...
$(function(){
	...
	$("#destaque-produtos").owlCarousel({
  	...
  	$('.estrelas').each(function(){
  		...
  		$(this).raty({
	  		starHalf    : 'resources/core/lib/raty/lib/images/star-half.png',                                // The name of the half star image.
			starOff     : 'resources/core/lib/raty/lib/images/star-off.png',                                 // Name of the star image off.
			starOn      : 'resources/core/lib/raty/lib/images/star-on.png',
